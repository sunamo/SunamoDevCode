...
public class ConstsManager
{
    ...
    ///     XlfKeys.cs
    /// </summary>
    public readonly string pathXlfKeys;
    ...
    private readonly Func<string, bool> XmlLocalisationInterchangeFileFormatIsToBeInXlfKeys;
    private static Type type = typeof(ConstsManager);

    public void AddKeysConsts(List<string> keysAll, int first, List<string> lines, List<string> valuesAll = null)
    {
        var csg = new CSharpGenerator();

...
internal partial class CA
{
    ...
    internal static List<string> WrapWith(List<string> list, string wrapText) => WrapWith(list, wrapText, wrapText);
    ...
    internal static List<string> ToListString(params string[] values) => values.ToList();
}

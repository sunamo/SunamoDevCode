...
public partial class FoldersWithSolutions
{
    ...
    public static SolutionFolder CreateSolutionFolder(ILogger logger, string documentsFolder, SolutionFolderSerialize solutionFolderData, string solutionFolder, PpkOnDriveDC toSelling, string? projName = null)
    {
        ...
        SolutionFolder solutionFolderInstance = solutionFolderData != null
            ? new SolutionFolder(solutionFolderData)
            : new SolutionFolder();
    ...
    public List<SolutionFolder> GetSolutions(RepositoryLocal repository, bool isLoadingAll = true, IList<string>? skipThese = null)
    {
        ...
        var skip = skipThese != null ? skipThese.ToList() : new List<string>();
        ...
        var dict = new Dictionary<string, Wildcard>();
    ...
    private List<string> ReturnAllProjectFolders(params string[] additionalFolders)
    {
        ...
        //else
        //{
        var visualStudioFolders = new List<string>([basePath]); // Directory.GetDirectories(folderWithVisualStudioFolders, VpsHelperSunamo.IsQ ? "_" : SolutionsIndexerStrings.VisualStudio2017, SearchOption.TopDirectoryOnly));
        ...
        foreach (var vsFolder in visualStudioFolders)
        {
            ...
            var languageFoldersOutsideVs17 = new List<string>();
            try
            {
...
#region New
    ...
    {
        ReturnNormalAndSpecialFolders(folder, out var specialFolders, out var normalFolders);

...
public partial class CsFileFilter : ICsFileFilter
{
    ...
    private bool Is(bool flagValue, bool negate) => BTS.Is(flagValue, negate);
    ...
    public class Contains
    {
        ...
        private static bool ContainsPattern(string pattern) => unindexablePaths.Contains(pattern);
    }

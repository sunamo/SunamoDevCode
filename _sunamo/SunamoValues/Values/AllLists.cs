...
");
    ...
    /// </summary>
    public static List<string> genericDomains = new List<string>([".com", ".org", ".net"]);
    /// <summary>
    /// parsed with WikipediaHelper.HtmlEntitiesList
    /// </summary>
    public static List<string> htmlEntities = null;
    public static readonly List<string> BasicImageExtensions = new List<string>([".png",
        ".bmp",
        ".jpg",

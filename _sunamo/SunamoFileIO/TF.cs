...
//    }
//    internal static List<string> ReadAllLines(string path)
//    {
//        return ReadAllLines(path, false);
//    }
//    internal static List<string> ReadAllLines(string path, bool createEmptyIfWasNotExists = false)
//    {
//        if (createEmptyIfWasNotExists)
//            if (!File.Exists(path))
//            {
...
//    #region Bytes
//    /// <summary>
//    ///     Only one method where could be File.ReadAllBytes
//    /// </summary>

...
{
    private static void RemoveNullOrEmpty(ChangeContentArgsDevCode a, List<string> files_in)
    {
        if (a != null)
        {
            if (a.removeNull)
    ...
    internal static List<string> ChangeContent0(ChangeContentArgsDevCode a, List<string> files_in, Func<string, string> func)
    {
    ...
    /// <param name="a1"></param>
    /// <returns></returns>
    internal static List<string> ChangeContent1(ChangeContentArgsDevCode a, List<string> files_in, Func<string, string, string> func, string a1)
    {
    ...
    /// <param name="a2"></param>
    /// <returns></returns>
    internal static List<string> ChangeContent2(ChangeContentArgsDevCode a, List<string> files_in, Func<string, string, string, string> func, string a1, string a2)
    {
        for (int i = 0; i < files_in.Count; i++)
        {
    ...
    /// <param name="files_in"></param>
    /// <param name="func"></param>
    internal static bool ChangeContentWithCondition(ChangeContentArgsDevCode a, List<string> files_in, Predicate<string> predicate, Func<string, string> func)
    {
        bool changed = false;
        for (int i = 0; i < files_in.Count; i++)
        {
    ...
    internal static List<string> ChangeContent<Arg1>(ChangeContentArgsDevCode a, List<string> files_in, Func<string, Arg1, string> func, Arg1 arg, Func<Arg1, string, string> funcSwitch12 = null)
    {
        if (a == null)
        {
            a = null;
    ...
    /// <param name="files_in"></param>
    /// <param name="func"></param>
    private static List<TResult> ChangeContent<T1, T2, TResult>(ChangeContentArgsDevCode a, Func<T1, T2, TResult> func, List<T1> files_in, T2 t2)
    {
        List<TResult> result = new List<TResult>(files_in.Count);
        for (int i = 0; i < files_in.Count; i++)
        {
    ...
    internal static List<string> ChangeContent<Arg1, Arg2>(ChangeContentArgsDevCode a, List<string> files_in, Func<string, Arg1, Arg2, string> func, Arg1 arg1, Arg2 arg2)
    {
        for (int i = 0; i < files_in.Count; i++)
        {
